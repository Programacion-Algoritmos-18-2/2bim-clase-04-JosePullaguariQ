...
class MiArchivo:#Creamos la clase Miarchivo
    ...
    def __init__(self):#Constructor de la clase
        """
        """
        self.archivo = codecs.open("data/informacion.csv", "r")#Direccion del archivo que vamos a utilizar y lo leemos con la palabra "r"
...
class MiArchivoEscribir:#Creamos la clase Mi Archivo escribir
    ...
    def __init__(self):#Constructor de la clase
        """
        """
        self.archivo = codecs.open("data/informacion2.csv", "a") #Direccion de alrchivo que va a escribir o para crearlo si no existe, utilizamos la palabra "a"

    def agregar_informacion(self, p):#Metodo para escribir informacion al archivo
        self.archivo.write("%s-%s-%d-%d" % (e.nombres, e.ciudad,\
